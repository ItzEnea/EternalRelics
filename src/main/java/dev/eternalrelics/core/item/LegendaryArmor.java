...
/**
 * Base class for legendary armor pieces
 * Provides common structure for all legendary armor
 */
public abstract class LegendaryArmor {
    ...
    protected LegendaryArmor(String id, String displayName, Material baseMaterial, int customModelData, NamedTextColor rarityColor) {
        this.id = id;
    ...
    /**
     * Builds the ItemStack for this armor piece
     */
